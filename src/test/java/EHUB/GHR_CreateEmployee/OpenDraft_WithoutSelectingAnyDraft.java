...
@Test
public class OpenDraft_WithoutSelectingAnyDraft extends BaseClass {

	public WebDriver driver;
		@Test
	public void openDraft_WithoutSelectingAnyDraft() throws IOException, InterruptedException
	{					
		//Start Chromedriver
	    ...
	    Assert.assertEquals(popup, "Select Draft");
